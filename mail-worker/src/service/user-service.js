...
const loginService = {
	async register(c, params, oauth = false) {
		...
		console.log('welcome mail account:', createdAccountRow);
...
<p>如需帮助，请联系管理员个人邮箱 <a href="mailto:jack121688@proton.me">jack121688@proton.me</a> 。</p>`,
				...
				status: emailConst.status.SUCCESS ?? 0,
				unread: emailConst.unread?.UNREAD ?? 0
			}).run();

			console.log('welcome mail inserted:', email);
		} catch (e) {
			console.error('welcome mail insert failed:', e);
		}
