const en = {
    ...
    regNameSub: 'Enter your name',
    nicknameOptional: 'Nickname (optional)',
    regEmailTitle: 'Choose your email address',
    regEmailSub: 'You will use it to sign in to {brand}',
    regPwdTitle: 'Create a strong password',
    regPwdSub: 'Use at least 6 characters with letters, numbers & symbols',
    ...
    footerAgree: 'By signing in or signing up, you agree to our',
    footerAnd: 'and',
